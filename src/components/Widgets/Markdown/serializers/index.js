...
import remarkEscapeMarkdownChars from './remarkEscapeMarkdownChars';
...
export const remarkToMarkdown = obj => {
  ...
  /**
   * Escape markdown characters found in text and html nodes within the MDAST.
   */
  const escapedMdast = unified()
    .use(remarkEscapeMarkdownChars)
    .runSync(mdast);
